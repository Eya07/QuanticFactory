...
--
-- Table structure for table `comptesadministratifs`
--

CREATE TABLE `comptesadministratifs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `exercice_comptable` varchar(255) DEFAULT '',
  `budget` varchar(255) DEFAULT '',
  `section_budgetaire_i_f` varchar(255) DEFAULT '',
  `sens_depense_recette` varchar(255) DEFAULT '',
  `type_d_operation_r_o_i_m` varchar(255) DEFAULT '',
  `chapitre_budgetaire_cle` varchar(255) DEFAULT '',
  `chapitre_niveau_vote_texte_descriptif` varchar(255) DEFAULT '',
  `nature_budgetaire_cle` varchar(255) DEFAULT '',
  `nature_budgetaire_texte` varchar(255) DEFAULT '',
  `fonction_cle` varchar(255) DEFAULT '',
  `fonction_texte` varchar(255) DEFAULT '',
  `mandate_titre_apres_regul` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
